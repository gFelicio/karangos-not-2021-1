...
export default function KarangosForm () {
    ...
    function handleInputChange (event) {
        // quando o nome de uma propriedade de um objeto aparece entre colchetes []
        ...
        <>
            ...
            <form>
                ...
                <TextField id="cor" 
                    ...
                    <MenuItem value="Branco">
                        Branco
                    </MenuItem>
                    <MenuItem value="Cinza">
                        Cinza
                    </MenuItem>
                    <MenuItem value="Dourado">
                        Dourado
                    </MenuItem>
                    <MenuItem value="Laranja">
                        Laranja
                    </MenuItem>
                    <MenuItem value="Marrom">
                        Marrom
                    </MenuItem>
                    <MenuItem value="Prata">
                        Prata
                    </MenuItem>
                    <MenuItem value="Preto">
                        Preto
                    </MenuItem>
                    <MenuItem value="Roxo">
                        Roxo
                    ...
                    <MenuItem value="Vermelho">
                        Vermelho
                    </MenuItem>
                </TextField>

                <TextField id="ano_fabricacao" 
